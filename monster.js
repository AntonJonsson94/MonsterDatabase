...
function printStatistics() {
    ...
    for (let i = 0; i < selectableColors.length; i++) {
        ...
        numberOfColorsParagaf.innerText = `Number of ${selectableColors[i]} monsters`;
...
//
//Skapar option-knapp för formuläret
...
//En funktion som skriver ut monster-korten
...
//gömmer formuläret för add monster
...
function filterMonsters() {
    ...
    //kör printMonsters och skickar med vår nya filtrerade lista med monsters
...
//Skriv ut antalet per monster typ och antal på samma färg
printStatistics();
